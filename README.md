...
pmotto（ピーモット）— PMO業務を、もっと効率的に。名前は「PMO ＋ もっと」から。

![CI](https://github.com/northraystudio/pmotto/actions/workflows/ci.yml/badge.svg)
...
社内のプロジェクトが増えるほど、経営側からは中身が見えなくなります。pmotto は次の4点を対象にしています。
...
| 対話から PMO 業務そのものを動かしたい | pmotto MCP による Claude 連携 | 構想 |
